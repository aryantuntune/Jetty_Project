...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-slate-800">Edit Operator</h2>
        <p class="text-slate-500 mt-1">Update operator details and branch assignment</p>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form action="{{ route('operator.update', $operator) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $operator->email) }}" required
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="mobile" id="mobile" value="{{ old('mobile', $operator->mobile) }}"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select name="branch_id" id="branch_id"
                        ...
                        <option value="{{ $branch->id }}" {{ (string) old('branch_id', $operator->branch_id) === (string) $branch->id ? 'selected' : '' }}>
                            {{ $branch->branch_name }}
                        </option>
                        @endforeach
                    </select>
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-slate-200">
                <a href="{{ route('operator.index') }}" class="px-5 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-medium hover:bg-slate-50 transition-colors">
                    Cancel
                </a>
