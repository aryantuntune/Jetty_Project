...
@section('page-title', 'Add Checker')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-slate-800">Add New Checker</h2>
        <p class="text-slate-500 mt-1">Create a new checker account with branch assignment</p>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form action="{{ route('checker.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
