...
@section('title', 'Edit Special Charge')
@section('page-title', 'Edit Special Charge')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-slate-800">Edit Special Charge</h2>
        <p class="text-slate-500 mt-1">Update branch-specific special charge</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <form method="POST" action="{{ route('special-charges.update', $specialCharge->id) }}" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select name="branch_id" required class="w-full pl-12 pr-10 py-3 rounded-xl border border-slate-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all appearance-none bg-white">
                        ...
                        <option value="{{ $branch->id }}" @selected(old('branch_id', $specialCharge->branch_id) == $branch->id)>{{ $branch->branch_name }}</option>
                        @endforeach
                    </select>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" min="0" name="special_charge" value="{{ old('special_charge', $specialCharge->special_charge) }}" required class="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all">
                </div>
