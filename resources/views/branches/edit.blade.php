...
<div class="flex justify-center items-center min-h-screen bg-gray-200 container mx-auto p-4">
    <div class="win-card w-1/2">
        ...
        <!-- Form -->
        <form action="{{ route('branches.update', $branch->id) }}" method="POST" class="p-4 space-y-3">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="branch_id" id="branch_id"
                       ...
                       value="{{ old('branch_id', $branch->branch_id) }}" required>
                @error('branch_id')
            ...
            <div class="win-footer mt-4">
                ...
                <button type="submit" class="btn-save">Update Branch</button>
            </div>
        </form>
    </div>
</div>
