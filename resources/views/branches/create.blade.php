    ...
    <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-primary-600 to-primary-700">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="font-semibold text-white">Add New Branch</h2>
        ...
        <form action="{{ route('branches.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" name="branch_id" id="branch_id" value="{{ old('branch_id') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none @error('branch_id') border-red-500 @enderror" placeholder="Enter branch ID" required>
            ...
            <div>
                ...
                <input type="text" name="branch_name" id="branch_name" value="{{ old('branch_name') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 outline-none @error('branch_name') border-red-500 @enderror" placeholder="Enter branch name" required>
