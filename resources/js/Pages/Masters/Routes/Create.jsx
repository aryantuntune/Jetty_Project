...
export default function Create({ branches, nextRouteId }) {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                <h1 className="text-xl font-bold text-slate-800 mb-6">Create New Route</h1>
...
Create.layout = (page) => <Layout title="Create Route">{page}</Layout>;
