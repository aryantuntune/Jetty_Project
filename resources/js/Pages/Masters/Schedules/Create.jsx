...
export default function SchedulesCreate({ branches }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('ferry_schedules.store'));
    };
            ...
            <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Create a new ferry departure time
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                <div className="px-6 py-4 border-b border-slate-200 flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">Enter the departure time</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex items-center justify-end space-x-3 pt-6 border-t border-slate-200">
                        ...
                        >
                            ...
                            <span>{processing ? 'Saving...' : 'Save Schedule'}</span>
                        </button>
                    </div>
                </form>
            </div>
...
SchedulesCreate.layout = (page) => <Layout children={page} title="Add Schedule" />;
