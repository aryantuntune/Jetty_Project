...
export default function SpecialChargesEdit({ specialCharge, branches, errors }) {
    const [formData, setFormData] = useState({
        branch_id: specialCharge?.branch_id || '',
        special_charge: specialCharge?.special_charge || '',
    });
    ...
    const handleSubmit = (e) => {
        ...
        router.put(route('special-charges.update', specialCharge.id), formData, {
    ...
    return (
        <>
            <Head>
                <title>Edit Special Charge - Jetty Admin</title>
            </Head>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    ...
                    <div className="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-emerald-600 to-emerald-700">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="font-semibold text-white">Edit Special Charge</h2>
                                <p className="text-sm text-emerald-100">Update branch-specific special charge</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="flex items-center justify-end gap-4 pt-4 border-t border-slate-200">
                            ...
                            >
                                ...
                                <span>Update Special Charge</span>
                            </button>
                        </div>
                    </form>
                </div>
...
SpecialChargesEdit.layout = (page) => <Layout>{page}</Layout>;
