...
export default function ItemRatesEdit({ itemRate, branches, categories }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        item_short_name: itemRate?.item_short_name || '',
        item_category_id: itemRate?.item_category_id || '',
        item_rate: itemRate?.item_rate || '',
        item_lavy: itemRate?.item_lavy || '',
        branch_id: itemRate?.branch_id || '',
        starting_date: formatDate(itemRate?.starting_date),
        ending_date: formatDate(itemRate?.ending_date),
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('item-rates.update', itemRate.id));
    };
            ...
            <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Update pricing for {itemRate?.item_name}
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                <div className="px-6 py-4 border-b border-slate-200 flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">Modify the item pricing information</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex items-center justify-end space-x-3 pt-6 border-t border-slate-200">
                        ...
                        >
                            ...
                            <span>{processing ? 'Saving...' : 'Update Rate Slab'}</span>
                        </button>
                    </div>
                </form>
            </div>
...
ItemRatesEdit.layout = (page) => <Layout children={page} title="Edit Rate Slab" />;
