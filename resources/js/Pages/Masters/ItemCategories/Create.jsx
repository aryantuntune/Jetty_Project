...
export default function ItemCategoriesCreate({ errors }) {
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route('item_categories.store'), formData, {
    ...
    return (
        <>
            <Head>
                <title>Add Item Category - Jetty Admin</title>
            </Head>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    ...
                    <div className="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-indigo-600 to-indigo-700">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="font-semibold text-white">Add New Item Category</h2>
                                <p className="text-sm text-indigo-100">Fill in the details below</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Enter category name (e.g., Adult, Child, Two Wheeler)"
                                required
                                autoFocus
                            />
                            ...
                            <p className="mt-2 text-sm text-slate-500">
                                Categories are used to group item rates (e.g., Passengers, Vehicles)
                            </p>
                        </div>
...
ItemCategoriesCreate.layout = (page) => <Layout>{page}</Layout>;
