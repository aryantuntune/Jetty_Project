...
export default function ManagersCreate({ branches, ferryboats }) {
    ...
    return (
        <>
            ...
            <div className="mb-8">
                ...
                <h1 className="text-2xl font-bold text-slate-800">Add Manager</h1>
                <p className="mt-1 text-sm text-slate-500">Create a new branch manager</p>
            </div>
            ...
            <div className="max-w-2xl">
                <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-200 flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="font-semibold text-slate-800">Manager Details</h2>
...
ManagersCreate.layout = (page) => <Layout children={page} />;
