...
export default function ManagersEdit({ manager, branches, ferryboats }) {
    ...
    const form = useForm({
        ...
        ferry_boat_id: manager.ferry_boat_id || '',
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        form.put(route('manager.update', manager.id));
    };

    return (
        <>
            <Head title={`Edit ${manager.name}`} />
            ...
            <div className="mb-8">
                ...
                <h1 className="text-2xl font-bold text-slate-800">Edit Manager</h1>
                <p className="mt-1 text-sm text-slate-500">Update manager details</p>
            </div>
            ...
            <div className="max-w-2xl">
                <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-200 flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="font-semibold text-slate-800">{manager.name}</h2>
...
ManagersEdit.layout = (page) => <Layout children={page} />;
