...
export default function CheckersCreate({ branches, ferryboats }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        form.post(route('checker.store'));
    };

    return (
        <>
            <Head title="Add Checker" />
            ...
            <div className="mb-8">
                ...
                <p className="mt-1 text-sm text-slate-500">Create a new ticket verification checker</p>
            </div>
            ...
            <div className="max-w-2xl">
                <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-200 flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="font-semibold text-slate-800">Checker Details</h2>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200">
                            ...
                            >
                                {form.processing ? 'Creating...' : 'Create Checker'}
                            </button>
                        </div>
                    </form>
                </div>
...
CheckersCreate.layout = (page) => <Layout children={page} />;
